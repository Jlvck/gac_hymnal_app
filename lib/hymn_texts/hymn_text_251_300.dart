...
class HymnText251to300 {
  List<HymnNotifier> hymnLyrics = <HymnNotifier>[
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "But, in the hour of grief of pain,",
    ...
    HymnNotifier(id: '257', versesYoruba: [
      [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "Beneath the chastening rod",
          "That will lean upon its own God",
          "Declares, 'We will conquer'"
        ],
        [
          "A faith that, shows more bright and clear",
          "In darkness feels no doubt",
          "For God has given me promise",
          "His word shall never fail."
        ],
        [
          "Lord give us such a faith as this,",
          "That faith that never fails",
          "The faith like ever fix’ed mark",
          "Bends not till its victory."
        ]
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          "This salvation, ‘tis salvation,",
          "We sinners all cherish",
          "Because the evil we have done",
          "Has caused our destruction."
        ],
        [
          "Every bit of work that we do.",
          "Reveals to us daily;",
          "That it leads not to salvation",
          "Not works can save our soul"
        ],
        [
          "Where O Lord comes our salvation",
          "Reveal it, reveal it",
          "Whether in heaven or down on earth,",
          "Tell us if Thou knowest."
        ],
        [
          "Jesus is only Redeemer",
          "He is our sovereign Lord,",
          "Salvation lies in His own hand",
          "To give to all sinners."
        ],
        [
          "Come now to Him and do receive",
          "There is pure love in Him",
          "He calls all those who are sinners",
          "O come and take it free."
        ]
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "In Christ am full formed again,",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "More meet for Thy Kingdom, O Lord; would I be",
          "More fruitful, more holy; More Saviour, like Thee."
        ]
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          "Till in my Father’s house",
          "Perfectly blest,",
          "After my journeying",
          "Safe and at rest,",
          "All my delight shall be",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "That truth to joys eternal flow",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "What a Father’s smile in thine;",
          "What a Saviour died win thee;",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "And this the prayer my lips are brining,",
        ...
        [
          ...
          "All discords husband, my peace a river,",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          "Once heaven seem’d a far-off place,",
          "Till Jesus show’d His smiling face;",
        ...
        [
          ...
          "In a cottage or a mansion fair?",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          "In the Book ‘tis written “Sav’d by Grace,",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "To here there are pleasures untold."
        ],
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          "Once I was away from the Lord",
          "With my life I made Him annoyed",
          "But Jesus has saved me now!"
        ],
        [
          "Animosity and anger",
          "Were the chains devil used for me",
          "Jesus has broken them all."
        ],
        [
          "Various lusts and thoughts filled my heart",
          "My life was filled up with all prides",
          "The fire of Spirit burnt them!."
        ],
        [
          "Freed from depression of the heart.",
          "From the spirit of lukewarmness",
          "Join me in praising the Lord!."
        ],
        [
          "I am now singing every day",
          "Dancing and also jumping up",
          "By the power of the Spirit."
        ],
        [
          "The precious blood has washed me clean",
          "Water of life springs from my heart,",
          "My salvation now is full!."
        ],
        [
          "Now, my relatives and all friends",
          "Who seek not for this salvation",
          "It is free right from Jesus."
        ],
      ],
      chorusEnglish: [
        "Oh how sweet will it be!",
        "Sweetly, sweetly, sweetly",
        "Oh how sweet will it be!",
        "For Jesus to reside in me."
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      chorusEnglish: [
        ...
        "And H will answer by and by:",
        "Now when you feel a little pray’er wheel turning,",
        "And you know a little fire is burning,",
        "You will find a little talk with Jesus make it right,",
        "It makes it right.",
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "And glory to God I’m home ward bound.",
        ],
        [
    ...
    HymnNotifier(id: '300', versesEnglish: [
      [

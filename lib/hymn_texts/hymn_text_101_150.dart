...
class HymnText101to150 {
  List<HymnNotifier> hymnLyrics = <HymnNotifier>[
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          "The heavenly controller",
          "The merciful and the wise;",
          "My whole life rests in Thy hand,",
          "The end of all lies with Thee."
        ],
        [
          "Thy power created the word,",
          "So Thou created myself;",
          "Parents, land, time we have around,",
          "All do come from Thee alone."
        ],
        [
          "Time of success and sound health,",
          "Time of poverty and wealth,",
          "Time of temptation and wrath,",
          "Time of victory and help."
        ],
        [
          "Time of exposing Satan,",
          "Time for tasting Jesus’ love;",
          "They do come but still roll by,",
          "As our Heavenly Friend wills."
        ],
        [
          "Thou, The-mercy-giving Lord,",
          "To Thee I commend my life;",
          "I confess Thy sweet great love.",
          "I bow down in great worship."
        ]
      ],
    ),
    HymnNotifier(
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          "Blessed invitation from the King of Heaven,",
          "Blessed invitation by the spirit given,",
          "Falling on the weary like refreshing dew,",
          "Who-so e’er believeth “that means you”."
        ],
        [
          "Reconciliation through His precious blood,",
        ...
        [
          "Saving all who trust Him to the utter-most,",
        ...
        [
          ...
          "Through His boundless mercy all shall be forgiven,",
        ...
        [
          ...
          "Glory Halleluyah, that means you."
        ]
      ],
      chorusEnglish: [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "Room, room, still room, oh, enter oh enter, enter now."
        ],
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "Thy heart so long harden’d of sin to reprove,",
          "Resist not the Spirit, nor longer delay,",
          "God’s gracious entreaties many end with today."
        ],
        [
          "O child of the Kingdom, from sin’s service cease;",
          "Be fill’d with the Spirit, with comfort and peace;",
          "Oh, grieve not the Spirit, thy teacher is He,",
          "That Jesus thy Saviour may glorified be."
        ],
        [
          "Defile is the temple, its beauty laid low,",
          "On God’s holy altar the members faint flow,",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "Haste to the supper of mu Lord!",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "I found in Him arresting-place,",
    ...
    HymnNotifier(id: '119', versesEnglish: [
      [
        "“Whosoever hearth!” shout,",
        "Shout the sound!",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "All His risen life and fullness,",
          "Filling He members still may share."
        ],
        [
          "Jesus only is our Power,",
          "His the gift of Pentecost;",
          "Jesus, breathe Thy power upon us,",
          "Fill us with the Holy Gosh."
        ],
        [
    ...
    HymnNotifier(id: '123', versesYoruba: [
      [
      ...
      [
        "Would you do service for Jesus you King",
        "There’s power in the blood, power in the blood,",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          "I have a precious Saviour, He came from heaven above;",
          "And died for me on Calvary, To prove",
          "His matchless love;",
          "This love so freely given, He offers now to you;",
          "Won’t you let my Saviour be your Saviour too?"
        ],
        [
          "I have a loving Saviour, He hears me when I call;",
          "He helps to bear each load of care, and lifts me when I fall;",
        ...
        [
          ...
          "Some day in all His glory My Saviour I shall view;",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "In accents hushed the throng rely;",
        ...
        [
          "But if you still this call refuge",
          "And all His wondrous love abuse,",
          "Soon will He sadly from you turn",
          "Your bitter prayer for pardon spurn.",
          "“Too late! Too late! Will be the cry",
          "“Jesus of Nazareth has passeth by”"
        ]
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "And mu only hope and plea",
          "Are in Him, and Him alone:",
          "God be merciful to me."
        ],
        [
          "He my cause will undertake,",
          "My cause will undertake,",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "Thou art all I care for,",
          "With all faith l lift up my eyes",
          "Thou wilt accept my prayer;",
          "Let me stay here for Thee",
          "That I may do Thy will",
          "And think O my almighty God,",
          "Renew me with all strength."
        ],
        [
          "Give me a humble heart",
          "That sacrifice itself,",
          "That threats upon that ridicules",
          "Satan’s machinations: A heart that values much",
          "The pangs of pain and toil",
          "That with patience and all boldness",
          "Bear its own cross alone."
        ],
        [
          "Give me the heavenly care,",
          "A bold and as sharp face",
          "That looks to Thee when sins draw near",
          "That drives away satan.",
          "O give me the Spirit,",
          "Which Thou has provided",
          "Spirit that stays steadfast for aye",
          "That watches while praying."
        ],
        [
          "I trust only Thy word,",
          "Thou gave me this promise",
          "That all my help and salvation",
          "Shall come only from Thee:",
          "Just let me stand steadfast,",
          "That my hope might not shake",
          "Until thou shall ring my spirit",
          "To Thy ‘verlasting rest."
        ]
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          "The blood which thou had shed",
          "Which is free give grave,",
          "Can clean me a sinner of bad;",
          "Can soften hardened heart."
        ],
        [
          "I worship at thy feet",
          "Forgive to me my sins,",
          "Here I’II not arise on my knees",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "From earthborn passion set me free",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          "As that publican O my Lord;",
          "I place my heart in thee,",
          "Lord speak to my heart with Thy grace",
          "“Have mercy on me Lord”"
        ],
        [
          "My unrest heart I always beat,",
          "From where tears and pains flow;",
          "Hear me in this most painful state,",
          "Have mercy on me Lord."
        ],
        [
          "In shame I confess all my sins,",
          "Strengthen my sincere hope:",
          "I plead for sake of Jesus’ blood,",
          "“Have mercy on me Lord”"
        ],
        [
          "Greatest of all sinners I am,",
          "Count not my sins O Lord,",
          "But for the sake of Jesus’ death,",
          "“Have mercy on me Lord”"
        ],
        [
          "I stand by the most painful cross,",
          "I fear not Thy shadow;",
          "Because God of merciful eyes,",
          "Forgive me my sins."
        ]
      ],
      versesYoruba: [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "Yet repeatedly I,",
          "More sins commit,",
          "By not loving Thee more",
          "And by my waning faith",
          "And by my waning faith",
          "A sin so great."
        ],
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "When I soar through eternity",
          "See Thee on Thy mercy throne,",
          "Rock of ages, cleft for me,",
          "Let me hide myself in Thee."
        ],
      ],
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "In Thy mercy let me hid:",
          "O Save me at the Cross!",
        ],
        [
          "Tho’ I do not know the way",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          "There are depths of love that I can know",

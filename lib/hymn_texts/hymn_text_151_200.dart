  ...
  List<HymnNotifier> hymnLyrics = <HymnNotifier>[
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "When I just tell him Jesus loves me."
        ]
      ],
      chorusEnglish: [
        "I am so glad that Jesus loves me,",
        "Jesus loves me, I am so glad that Jesus loves me",
        "Jesus loves even me."
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          "Oh let Thine unction on them rest,",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "Beautiful though, while walking therein:",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "Fresh soldiers to the Saviour’s cause,",
          "Who thus, baptized into His name,",
          "His goodness and their faith proclaim."
        ],
        [
          "For these now added to the host",
          "Who in their Lord and Saviour boast,",
        ...
        [
          ...
          "Themselves His subjects to declare,",
          "And place themselves beneath His care."
        ],
        [
          "Lead them at once their Lord to own,",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          "The dying thief rejoice’d to see,",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          "I know there’s power in Jesus blood,",
          "For He wash’d my sins away;",
          "And I know there is joy in serving Him;",
          "For He turn’d my night to day."
        ],
        [
          "I know there is pow’r in Jesus’ blood,",
          "From my guilt He set me free,",
          "When I came unto Him with all my sin",
          "And His blood avail’d for me."
        ],
        [
          "I know there is pow-r in Jesus’ blood,",
          "For all things have been made new;",
          "Since His own precious blood has been applied,",
          "And has cleans’d me thro’ and thro’"
        ]
      ],
      chorusEnglish: [
        "There is pow’r, pow’r wonder working power",
        "There is pow-er, pow-er purifying pow-er",
        "There is pow-er in Jesus’ blood."
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      chorusEnglish: [
        ...
        "In the soul-cleaning blood of the Lamb?",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "And drink with faith the blood for you outpour’d."
        ],
        [
          "Saved by His body, hallow’d by His blood,",
        ...
        [
          "He, that in this world rules his saint and shields.",
          "To all believers life eternal yields."
        ],
        [
          "With heavenly bread make that hunger whole,",
      ...
      versesYoruba: [
        ...
        [
          "Gbogb' ebo awon Ju l'aiye 'gbani.",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          "Rejoice Jesus reigneth,",
          "Amongst the sons of men,",
          "He doned all the prisoners",
          "And set them free for aye.",
          "If Satan stands ‘gainst son of God:",
          "Still His work goes on unhindered."
        ],
        [
          "Mission of righteousness,",
          "Justice and peace combined,",
          "For life, to make easy,",
          "Shall spread over the earth.",
          "All pagans, Jews shall bow their heads",
          "And confess His holy worship."
        ],
        [
          "The power at His command",
          "For his own be preserved,",
          "His high authority",
          "Will many pay respect;",
          "The joyful Heavens note His works,",
          "Distant Islands obey His laws."
        ],
        [
          "This heavenly seedlings",
          "Shall form a mighty tree,",
          "As all the blessed bread:",
          "Were made to feed mankind.",
          "Until Son of God shall come back",
          "We will wait proclaiming the News."
        ]
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      versesYoruba: [
        ...
        [
          "T' ite Re wi fun Keferi.",
          "\"Emi Jehofa Olorun\".",
          "Ohun Re y' o d' ere won ru",
          "Yio wo pepe won lule.",
        ],
        [
          "Ki gb'oju rere Sion de",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          "Work on and never be weary,",
          "Do Thy Father’s duty in faith",
          "Son Jesus did while on this earth,",
          "Should we not emulate our Christ?"
        ],
        [
          "Work on and do it every day",
          "The world’s darkness shall soon come in,",
          "Work on and avoid indolence,",
          "That He may save Thy soul at last."
        ],
        [
          "Many are those that remaineth",
          "Who do not have heavenly hope;",
          "Light on the light of the Gospel,",
          "Sink it not in the world’s darkness."
        ],
        [
          "Work on and be joyous in it",
          "After the labor comes the rest",
          "Soon the voice of Jesus you’ll hear",
          "That would declare “I have arrived”"
        ]
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "Christians, awake! Your force all uniting,",
        ...
        [
          "God speed thee, when those of ev’ry nation,",
          "“Glory to God” triumphantly shall sing,",
          "Ransomed, redeemed, rejoicing in salvation,",
          "Shout “Halleluyah, for the Lord is King!”"
        ]
      ],
      chorusEnglish: [
      ...
      versesYoruba: [
        ...
        [
          ...
          "Ti gbogb'aiye y'o maa f'ogo fun O",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          "Send aboard the gospel heralds,",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "For whom Thou sav’st, ne’er shall fail."
        ]
      ],
      versesYoruba: [
        [
        ...
        [
          ...
          "F' orin opę bukun fun O;",
          "Iyin't' o ye oruko Rę",
          "Ni ngo ma gbe s' oke si O.",
        ],
        [
    ...
    HymnNotifier(
      ...
      versesYoruba: [
        ...
        [
          ...
          "Jęki emi iwosan bà le wa loni yi,",
          "We abawon ese nu, si ṣakoso wa,",
          "So f' okan t'o nwa O pe",
          "\"O nfe wosan bi,\"?",
        ],
      ],
      chorusYoruba: [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          "O my God upon Thee is call",
          "Painful I am my prayer hear,",
          "When I am drowned in sinful deeds",
          "Let all my hearts remain unchanged."
        ],
        [
          "Thou who ask friend to a weakling",
          "Who is ready to hear my cry",
          "Except Thee O and Thee alone",
          "Who invites poor to His side."
        ],
        [
          "Who has once poured unfruitful tears",
          "That was rejected of Thee Lord?",
          "For Thou hast given the promised Lord:",
          "That no one shall find Thee in vain."
        ],
        [
          "This would have been my great sorrow;",
          "That Thou doth not answer prayer",
          "But Thou the prayer answering God",
          "Has always been helping me through."
        ],
        [
          "I know that I am very poor,",
          "But God would never forget me,",
          "Whom the Saviour Lord pleadeth for",
          "Cometh safely not of sorrow."
        ]
      ],
      versesYoruba: [
        [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          "Wonder story of love;",
          "Jesus provide a rest,",
          "Wonderful story of love;",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        [
          ...
          "Who the heav’nly path-way leave,",
    ...
    HymnNotifier(
      ...
      chorusEnglish: [
        "Tell it to Jesus, tell to Jesus,",
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "To them, “I will” was every Thy reply",
          "We rest upon it now."
        ]
      ],
      chorusEnglish: [
    ...
    HymnNotifier(
      ...
      versesEnglish: [
        ...
        [
          ...
          "Which oppress’d my heart within,",
        ...
        [
          "He is not a disappointment!",
          "He has healed my body too;",
          "What a tender, mighty Saviour,",
          "There is naught He cannot do!",
          "When on earth He heal’d diseases",
          "As they touch’d Him in the throng;",
          "Has He lost His heart of pity?",
          "Is the Risen Christ less strong?"
        ],
        [
          "He is not a disappointment!",

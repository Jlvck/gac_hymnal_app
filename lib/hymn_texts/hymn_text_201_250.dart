  ...
  List<Hymn> hymnLyrics = <Hymn>[
    Hymn(
      ...
      versesEnglish: [
        ...
        [
          "Ye children to men, attend to the word",
        ...
        [
          ...
          "The life ever-lasting if ye would obtain,",
          "“Ye must be born again”"
        ],
        [
    ...
    //TO DO:check integrity of HYMN 202
    Hymn(
      id: '202',
      versesEnglish: [
        [
        ...
        [
          ...
          "While at the footstools of mercy",
    ...
    Hymn(
      ...
      versesEnglish: [
        [
          ...
          "Guide and counsel to mortals given",
          "Lamp to the faith by the ransomed trod",
        ...
        [
          ...
          "Ray service for the world above;",
    ...
    Hymn(
      ...
      versesEnglish: [
        [
          "O Thou holy word of God",
          "Thou wisdom from above,",
          "The truth that never changeth",
          "Our only light of life;",
          "We praise thee all for the light",
          "From the holy gospel,",
          "A light to lighten our feet",
          "That shine for evermore."
        ],
        [
          ...
          "full of all righteousness,",
          "“Tis the resemblance of Christ",
          "The true and living word."
        ],
        [
          "It flieth high as a flag",
          "That flies high in the sky,",
          "Like an Evangelist light",
          "Shines in the world’s darkness,",
          "It is a guide to all men",
          "Amidst all ups and downs,",
          "Amidst water of trouble",
        ...
        [
          ...
          "Teach people who are misled",
          "To make use of this light,",
          "Till world’s darkness disappear",
          "And all have seen Thy face."
        ]
      ],
      versesYoruba: [
        [
    ...
    Hymn(
      ...
      versesEnglish: [
        ...
        [
          ...
          "Given me a heart to find out Thee,",
    ...
    Hymn(
      ...
      versesEnglish: [
        ...
        [
          "But there is a power, which man can wield",
    ...
    Hymn(
      ...
      versesEnglish: [
        [
          "Lord be with us with Thy blessing,",
    ...
    Hymn(
      ...
      versesEnglish: [
        [
          ...
          "Teach me, Lord, the rapturous measures",
    ...
    Hymn(
      ...
      versesEnglish: [
        ...
        [
          ...
          "Then, when Thy voice shall bid our conflicts cease,",
    ...
    Hymn(
      ...
      versesEnglish: [
        [
          ...
          "A refuge stray failing never",
          "For His word is sure."
        ],
        [
          "My heart with joy now is telling",
          "Of Him who finds them a dwelling,",
    ...
    Hymn(
      ...
      versesEnglish: [
        ...
        [
          "Many loved ones have I in your heavenly throng",
    ...
    Hymn(
      ...
      versesEnglish: [
        [
          "All prayers He will answer,",
          "His sure promises is love;",
        ...
        [
          "All prayers He will answer;",
          "Let us all ask then in faith;",
          "His Spirit is there to help",
          "Glory to His matchless name."
        ],
        [
          "All prayers He will answer;",
          "Come before the mercy throne;",
          "There receiveth thou mercy",
          "Glory to His matchless name."
        ]
      ],
      versesYoruba: [
    ...
    Hymn(
      ...
      versesEnglish: [
        ...
        [
          "Whoever repents and forsake ev’ry sin,",
    ...
    Hymn(
      ...
      versesEnglish: [
        [
          ...
          "He will heal the wounded hearts,",
        ...
        [
          "Though I pass thro’ the night of sorrow,",
    ...
    Hymn(
      ...
      versesEnglish: [
        [
          ...
          "Jesus keeps me what-e’er betides,"
        ],
        [
    ...
    Hymn(
      ...
      versesEnglish: [
        [
          ...
          "He will uphold me by His mighty arm",
          "Ev’ry moment of my day."
        ],
        [
      ...
      chorusEnglish: [
        ...
        "I’ve a home far beyond the starry key,",
        "And you know that is just the reason why,",
        "I am singing Halleluyah."
      ],
      versesYoruba: [
        [
    ...
    Hymn(
      ...
      versesEnglish: [
        ...
        [
          ...
          "And made my poor heart His home."
        ]
      ],
      chorusEnglish: [
        "He never forgets His own",
        "He never forgets His own",
        "Tho’ friends deny, there is One so nigh,",
        "Who never forgets His own."
      ],
      versesYoruba: [
        [
    ...
    Hymn(
      ...
      versesEnglish: [
        ...
        [
          ...
          "Jesus had vanquish’d death and all its powers."
        ],
        [
